...
public class Operadores {
	...
	public static void main(String[] args) {
		...
		System.out.println("A soma do numero1 com o numero2 é igual a :" + (numero1 + numero2));
		
		System.out.println(" A soma das variaveis valo1 e valor2 é igual a:" + (valor1 + valor2));
